...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public void onClick(View v) {
		if(v.getId() == R.id.rl_switch_block_groupmsg) { // 屏蔽或取消屏蔽群组
			toggleBlockGroup();
		} else if(v.getId() == R.id.clear_all_history) { // 清空聊天记录
