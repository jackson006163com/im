...
public class SettingsFragment extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		if (v.getId() == R.id.rl_switch_notification) {
		...
		} else if (v.getId() == R.id.rl_switch_sound) {
		...
		} else if (v.getId() == R.id.rl_switch_vibrate) {
		...
		} else if (v.getId() == R.id.rl_switch_speaker) {
		...
		} else if (v.getId() == R.id.rl_switch_chatroom_owner_leave) {
		...
		} else if (v.getId() == R.id.rl_switch_delete_msg_when_exit_group) {
		...
		} else if (v.getId() == R.id.rl_switch_auto_accept_group_invitation) {
		...
		} else if (v.getId() == R.id.btn_logout) { //退出登陆
			logout();
		} else if (v.getId() == R.id.ll_black_list) {
			startActivity(new Intent(getActivity(), BlacklistActivity.class));
		} else if (v.getId() == R.id.ll_diagnose) {
			startActivity(new Intent(getActivity(), DiagnoseActivity.class));
		} else if (v.getId() == R.id.ll_set_push_nick) {
			startActivity(new Intent(getActivity(), OfflinePushNickActivity.class));
		} else if (v.getId() == R.id.ll_user_profile) {
